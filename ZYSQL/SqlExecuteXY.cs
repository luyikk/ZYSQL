...
namespace ZYSQL
{
    public class SqlExecuteXY : ListDeserializerBase, IDisposable
    {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public Task<int> SqlExecuteNonQueryAsync(string sql, params SqlParameter[] parem)
        {
        ...
        /// <param name="cannToken">CancellationToken</param>
        /// <returns></returns>
        public Task<int> SqlExecuteNonQueryAsync(string sql, CancellationToken canntoken, params SqlParameter[] parem)
        {
        ...
        /// <param name="cannToken">CancellationToken</param>
        /// <returns></returns>
        public Task<int> SqlExecuteNonQueryAsync(string sql, bool bolIsProcedure = false, params SqlParameter[] parem)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns>行数</returns>
        public Task<int> SqlExecuteNonQueryAsync(string sql, bool bolIsProcedure, CancellationToken cannToken, params SqlParameter[] parem)
        {
        ...
        /// <param name="commandBehavior"></param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql,
            CommandBehavior commandBehavior = CommandBehavior.Default)
        {
        ...
        /// <param name="commandBehavior"></param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, CancellationToken canToken)
        {
        ...
        /// <param name="commandBehavior"></param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, CancellationToken canToken, params SqlParameter[] parem)
        {
        ...
        /// <param name="commandBehavior"></param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, bool bolIsProcedure,
            CommandBehavior commandBehavior = CommandBehavior.Default)
        {
        ...
        /// <param name="commandBehavior"></param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, bool bolIsProcedure, CancellationToken canToken = default)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, CommandBehavior commandBehavior,
            params SqlParameter[] parem)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, CommandBehavior commandBehavior, CancellationToken canToken = default,
            params SqlParameter[] parem)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns></returns>
        public Task<SqlDataReader> SqlExecuteReaderAsync(string sql, bool bolIsProcedure, CommandBehavior commandBehavior, CancellationToken canToken,
            params SqlParameter[] parem)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public Task<object> SqlExecuteScalarAsync(string sql, params SqlParameter[] parem)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public Task<object> SqlExecuteScalarAsync(string sql, CancellationToken canToken, params SqlParameter[] parem)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns></returns>
        public Task<object> SqlExecuteScalarAsync(string sql, bool bolIsProcedure, CancellationToken canToken, params SqlParameter[] parem)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns>对象集合</returns>
        public Task<List<T>> SqlExcuteSelectObjectAsync<T>(string sql, params SqlParameter[] parem) where T : class, new()
        {
        ...
        /// <returns></returns>
        public Task<List<T>> SqlExcuteSelectObjectAsync<T>(string sql, CancellationToken canToken, params SqlParameter[] parem)
            where T : class, new()
        {
        ...
        /// <param name="bolIsProcedure">是否为存储过程</param>
        /// <returns>对象集合</returns>
        public Task<List<T>> SqlExcuteSelectObjectAsync<T>(string sql, bool bolIsProcedure, params SqlParameter[] parem) where T : class, new()
        {
        ...
        /// <param name="obj">填充对象</param>
        /// <returns>对象集合</returns>
        public Task<List<T>> SqlExcuteSelectObjectAsync<T>(string sql, bool bolIsProcedure, CancellationToken canToken, params SqlParameter[] parem) where T : class, new()
        {
